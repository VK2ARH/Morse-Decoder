...
The project support touch screen interfaces as well as any future implementation which makes use of the TFT's SD card reader.
...
Full details of the design brief and capability of the project together with links to the latest software can be found at Jon Web site : https://101-things.readthedocs.io/en/latest/ham_fist.html 
